    ...
    <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 order-lg-2 justify-content-center justify-content-sm-start">
      <div className="section social">
        ...
        <a href="https://www.facebook.com/jeffberlinracing" target="_blank" rel="noopener noreferrer">
          <Image  src="./images/facebook_circle_150px.png" alt="Facebook logo" title="Like on Facebook!" height={33} />
        </a>
        <a href="https://www.instagram.com/jeffberlinracing/" target="_blank" rel="noopener noreferrer">
          <Image src="./images/instagram_circle_150px.png" alt="Instagram logo" title="Follow on Instagram!" height={33} />
        </a>
        <a href="https://www.youtube.com/user/GymkhanaRally88" target="_blank" rel="noopener noreferrer">
          <Image src="./images/youtube_circle_150px.png" alt="YouTube logo" title="Subscribe on YouTube!" height={33} />
        </a>
        <a href="https://www.twitter.com/jeffberlinrally" target="_blank" rel="noopener noreferrer">
          <Image src="./images/twitter_circle_150px.png" alt="Twitter logo" title="Follow on Twitter!" height={33} />
        </a>
        <a href="https://www.linkedin.com/company/jeffberlinracing/" target="_blank" rel="noopener noreferrer">
          <Image src="./images/linkedin_circle_150px.png" alt="LinkedIn logo" title="Follow on LinkedIn!" height={33} />
        </a>
      </div>
    </div>
  )
